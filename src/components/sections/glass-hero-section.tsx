                ...
                <div className="text-center space-y-8 mb-16">
                    ...
                    <motion.div className="flex justify-center mb-8">
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-primary blur-xl opacity-50" />
                    ...
                    <motion.div className="space-y-6">
                        ...
                        >
                            Transforming businesses with cutting-edge technology. From web applications to IoT systems, we deliver excellence at every corner.
                        </motion.p>
                    </motion.div>
                ...
                >
                    {statsData.map((stat, index) => (
                        <motion.div
                            ...
                            className="group"
                        >
                            <Card className="relative p-6 text-center hover:glass-strong transition-all duration-300 bg-primary/10 border-none">
                                {/* Glow Effect */}
                                <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg" />
